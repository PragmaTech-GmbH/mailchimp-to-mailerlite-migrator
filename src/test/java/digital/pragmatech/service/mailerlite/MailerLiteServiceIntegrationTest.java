...
@SpringBootTest
@TestPropertySource(properties = {"api.mailerlite.base-url=http://localhost:8090/api"})
class MailerLiteServiceIntegrationTest {
  ...
  void createOrUpdateSubscriber() {
    ...
    stubFor(
        post(urlEqualTo("/api/subscribers"))
  ...
  void assignSubscriberToGroup() {
    ...
    stubFor(
        post(urlEqualTo("/api/subscribers/" + subscriberId + "/groups/" + groupId))
            .willReturn(
                aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
  ...
  void bulkImportSubscribers() {
    ...
    stubFor(
        post(urlEqualTo("/api/groups/" + groupId + "/import-subscribers"))
            .willReturn(
                aResponse()
                    .withStatus(200)
                    .withHeader("Content-Type", "application/json")
    ...
    verify(
        postRequestedFor(urlEqualTo("/api/groups/" + groupId + "/import-subscribers"))

...
class HomeControllerTest {
    ...
    void shouldDisplayIndexPageWithHtmlUnit() throws Exception {
        ...
        HtmlElement mainHeading = (HtmlElement) page.getFirstByXPath("//h1[contains(@class, 'text-3xl')]");
    ...
    void shouldDisplayResultsPageWithMigrationId() throws Exception {
        // When & Then
        mockMvc.perform(get("/results").param("migrationId", "test-123"))
                .andExpect(status().isOk())
                .andExpect(view().name("results"))
